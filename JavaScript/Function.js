...
// Hoisting -> The process of moving function declaration only(not function assignment) to the top of the file means all the function declaration will be hoisted to top. It is done by js engine
...
// sol();   We cannot call a function like this because hoisting only shifts function declaration not function assignment
...
solved(); // This function is same as sol because it's reference is copied

// This is known as Anonymous function Assignment
let sol2 = function () {
    console.log("This is solution 2");
};


const arr = [   // Array Of Function
    function (a, b) {
        return a + b;
    },
...
console.log(func1(1, 2, 3, 5));  // This will take first 2 values

function argu(val1, val2) {
    console.log(arguments);  // This will return an object which will contain arguments
    return val1 + val2;
}
argu(3, 4);
...
console.log(interest(1, undefined, undefined));  // This is same as upper line
...
let person = {
    ...
    set fullname(value) {  // This can have different name from getter
...
// person.fullname('Prachi Chaudhary'); // This tries to call fullname as a function, but fullname is defined as a getter/setter property, not a function.

console.log(person.fullname);  // In this getter is called



// Try...catch is used to handle errors in JavaScript without crashing the program

try {
    let divide = 5 / 0;  // This is not a error in case of java script
}
catch (e) {
    console.log("The is a error while computing this ");
    throw new Error("This is a new error Arithmetic Error");
}
